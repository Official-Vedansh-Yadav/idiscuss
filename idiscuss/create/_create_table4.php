...
$database = "3810958_crud";
    ...
    $sql = "CREATE TABLE `idiscuss`.`comments` ( `comment_id` INT(11) NOT NULL AUTO_INCREMENT ,  `comment_thread_id` INT NOT NULL ,  `comment_description` TEXT NOT NULL ,  `comment_user_id` INT NOT NULL ,  `time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,    PRIMARY KEY  (`comment_id`))";
