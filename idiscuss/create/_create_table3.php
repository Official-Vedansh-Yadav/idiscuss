...
$database = "3810958_crud";
    ...
    $sql = "CREATE TABLE `idiscuss`.`threads` ( `thread_id` INT(11) NOT NULL AUTO_INCREMENT ,  `thread_user_id` INT NOT NULL ,  `thread_description` TEXT NOT NULL, `thread_description` TEXT NOT NULL ,  `thread_cat_id` INT NOT NULL ,  `time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,    PRIMARY KEY  (`thread_id`))";
