...
$database = "3810958_crud";
    ...
    $sql = "CREATE TABLE `users988` ( `s.r.` INT NOT NULL AUTO_INCREMENT ,  `UserName` VARCHAR(150) NOT NULL ,  `E-Mail` VARCHAR(150) NOT NULL ,  `password` VARCHAR(322) NOT NULL ,  `Signup_Date` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ,    PRIMARY KEY  (`s.r.`))";
